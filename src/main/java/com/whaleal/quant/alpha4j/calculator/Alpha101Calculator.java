...
import com.whaleal.quant.alpha4j.Alpha101Config;
import com.whaleal.quant.alpha4j.Alpha101FactorOrder;
            ...
            try {
                ...
                if (alphaValue != null) {
                    ...
                    if (Double.isInfinite(alphaValue)) {
                        ...
                        factors.put("alpha4j" + String.format("%03d", i), 0.0);
                    } else {
                        // 保留 NaN 和正常值
                        factors.put("alpha4j" + String.format("%03d", i), alphaValue);
                    }
                } else {
                    factors.put("alpha4j" + String.format("%03d", i), 0.0);
                }
            } catch (Exception e) {
                log.warn("Failed to calculate alpha4j{}: {}", i, e.getMessage());
                factors.put("alpha4j" + String.format("%03d", i), 0.0);
            }
        }
